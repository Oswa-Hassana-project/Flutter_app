        ...
        builder: (context, state) {
          ...
          Widget prayerRimaine(){
            if(cubit.nextPrayer.isEmpty){
              return Text('صلاه العشاء منذ \t${cubit.timeFromLastPrayer!.inMinutes%60} : ${cubit.timeFromLastPrayer?.inHours}',style: TextStyle(fontSize: 15,color: Colors.white),textDirection: TextDirection.rtl,
              );
            }else {
              return Text('باقي علي صلاه ${cubit.nextPrayer}\t${minutes} : $hours',style: TextStyle(fontSize: 15,color: Colors.white),textDirection: TextDirection.rtl,
              );
            }
          }
