...
class AzkarDetailsPage extends StatefulWidget {
  ...
  AzkarDetailsPage({Key? key, required this.title,required this.azkar}) : super(key: key);
...
class _AzkarDetailsPageState extends State<AzkarDetailsPage> {
  ...
  void initState() {
    super.initState();
    remainList = List<int>.from(widget.azkar.array.map((item) => item.count.toInt()));
  }
                            ...
                            child: Card(
                              ...
                              child:Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(widget.azkar.array[index].text,textDirection: TextDirection.rtl,),
                                    SizedBox(height: heightR(5, context),),
                                    Text('المتبقي: ${remainList[index]}',textDirection: TextDirection.rtl,),
                                    SizedBox(height: heightR(5, context),),
                                    SizedBox(
                                      width: double.infinity,
                                      child: Row(
                                        ...
                                        children: [
                                          SizedBox(width: widthR(50, context),),
                                          Container(
                                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(sizeR(15, context)),
                                            ...
                                            child: ElevatedButton(
                                              onPressed: (){
                                                setState(() {
                                                  remainList[index] <= 0 ? remainList[index]=0 :
                                                  remainList[index]--;
                                                });
                                              },
                                          ...
                                          IconButton(onPressed: () {
                                            setState(() {
                                              remainList[index] = widget.azkar.array[index].count;
                                            });
            ...
            child: Padding(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    Text(widget.title,style: TextStyle(color: Colors.white,fontSize: sizeR(24, context),fontWeight: FontWeight.w700),),
                    SizedBox(width: 15,),
                  ]),
            ),
          ) ,
