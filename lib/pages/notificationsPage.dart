                ...
                child: SizedBox(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(
                        ...
                        vertical: heightR(24, context)),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Center(child: Text('Notifications',style: TextStyle(fontSize: sizeR(22, context),fontWeight: FontWeight.bold),)),
      ...
      child: Row(
        children: [
          ...
          Transform.scale(
            ...
            child: Switch(value: state, activeTrackColor: Colors.blue,
